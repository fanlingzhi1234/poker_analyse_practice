...
- 说明 / 反馈弹窗
- 结果页视觉优化
- 工作台式单页布局（左侧输入、右侧核心结果）
- 折叠式结果模块（减少单页信息压迫）
- 面向用户的顶部文案与更轻的果冻风卡片样式
...
- 分类范围选择
- 高级文本范围折叠输入
- 低频设置折叠区（URL / fallback / iterations / seed / player count）

### 结果区
- 主结论卡
- 第一屏固定 4 个核心结果：行动建议 / Equity / 当前牌型 / 一句记忆点
- Top 3 最可能最终牌型摘要
- Win / Tie / Lose 拆解
- 当前牌力与听牌
- 教练解释（Accordion）
...
1. 训练工作台增强
   - 结果区展示当前 Hero / Board
   - 当前工作台已经完成第一轮 UI/交互收口；后续应优先补移动端适配、首屏密度继续优化、以及更明确的空态/帮助提示
   - 场景切换更顺手
